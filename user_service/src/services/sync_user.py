...
class SyncUserService:
    ...
    async def execute(self, user_id: UUID, username: str, email: str, create_if_missing: bool = False) -> User:
        try:
            ...
            if not create_if_missing:
                raise
            user = User(id=user_id, username=username, email=email, status="active")
