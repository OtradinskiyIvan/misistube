...
class TestUserRepository:
    async def test_create_and_get_by_id(
        ...
        user = User(id=uuid4(), username="repo_user", email="repo@example.com")
    ...
    async def test_get_by_username(
        ...
        user = User(id=uuid4(), username="findme", email="find@example.com")
    ...
    async def test_get_by_email(
        ...
        user = User(id=uuid4(), username="email_test", email="unique@example.com")
        await repository.create(user)
        await uow.commit()
    ...
    async def test_update_user(
        ...
        user = User(id=uuid4(), username="before", email="before@example.com")
        await repository.create(user)
        await uow.commit()
    ...
    async def test_update_not_found(
        ...
        user = User(id=uuid4(), username="ghost", email="ghost@example.com")
        with pytest.raises(UserNotFoundError):
            await repository.update(user)
    ...
    async def test_delete_user(
        ...
        user = User(id=uuid4(), username="delete_me", email="delete@example.com")
        await repository.create(user)
        await uow.commit()
    ...
    async def test_duplicate_username(
        ...
        uid1 = uuid4()
        uid2 = uuid4()
        user1 = User(id=uid1, username="duplicate_user", email="first@example.com")
        await repository.create(user1)
        await uow.commit()

        user2 = User(id=uid2, username="duplicate_user", email="second@example.com")
    ...
    async def test_duplicate_email(
        ...
        uid1 = uuid4()
        uid2 = uuid4()
        user1 = User(id=uid1, username="unique1", email="dup_email@example.com")
        await repository.create(user1)
        await uow.commit()

        user2 = User(id=uid2, username="unique2", email="dup_email@example.com")
        with pytest.raises(UserAlreadyExistsError):
            await repository.create(user2)
    ...
    async def test_unique_constraint_violation(
        ...
        user = User(id=uuid4(), username="unique_test", email="unique@test.com")
        await repository.create(user)
        await uow.commit()

        duplicate = User(id=uuid4(), username="unique_test", email="other@test.com")
